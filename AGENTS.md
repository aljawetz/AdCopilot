...
If Sprint 1 and Sprint 2 disagree on **scope**, follow Sprint 2. Use Sprint 1 for rationale, examples, and the metric identities (`CPA = CPC ÷ CVR`, `CPC = (CPM ÷ 1000) ÷ CTR`) when Sprint 2 is silent.
